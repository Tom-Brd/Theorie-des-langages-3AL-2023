...
_lr_productions = [
  ...
  ('start -> statement SEMICOLON start','start',3,'p_bloc','calcBase.py',90),
  ('start -> statement SEMICOLON','start',2,'p_bloc','calcBase.py',91),
  ('start -> SIMPLE_COMMENT start','start',2,'p_bloc','calcBase.py',92),
  ('start -> SIMPLE_COMMENT','start',1,'p_bloc','calcBase.py',93),
  ('start -> MULTI_COMMENT start','start',2,'p_bloc','calcBase.py',94),
  ('start -> MULTI_COMMENT','start',1,'p_bloc','calcBase.py',95),
  ('statement -> PRINT LPAREN expression RPAREN','statement',4,'p_statement_expr','calcBase.py',99),
  ('statement -> PRINTSTRING LPAREN STRING RPAREN','statement',4,'p_statement_expr','calcBase.py',100),
  ('statement -> TOAMSCAN LPAREN NAME RPAREN','statement',4,'p_statement_toamScan','calcBase.py',105),
  ('statement -> NAME EQUALS SCAN LPAREN RPAREN','statement',5,'p_statement_scan','calcBase.py',110),
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','calcBase.py',115),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop_operations','calcBase.py',120),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop_operations','calcBase.py',121),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop_operations','calcBase.py',122),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop_operations','calcBase.py',123),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calcBase.py',137),
  ('expression -> NUMBER','expression',1,'p_expression_number','calcBase.py',142),
  ('expression -> NAME','expression',1,'p_expression_name','calcBase.py',147),
  ('expression -> STRING','expression',1,'p_expression_string','calcBase.py',152),
  ('expression -> expression AND expression','expression',3,'p_expression_binop_bool','calcBase.py',157),
  ('expression -> expression OR expression','expression',3,'p_expression_binop_bool','calcBase.py',158),
  ('expression -> expression GREATER expression','expression',3,'p_expression_binop_bool','calcBase.py',159),
  ('expression -> expression LESS expression','expression',3,'p_expression_binop_bool','calcBase.py',160),
  ('expression -> expression GREATER expression GREATER expression','expression',5,'p_expression_compare','calcBase.py',173),
  ('expression -> NAME INCREMENT','expression',2,'p_expression_incr_decr','calcBase.py',179),
  ('expression -> NAME DECREMENT','expression',2,'p_expression_incr_decr','calcBase.py',180),
  ('expression -> NAME INCREASE expression','expression',3,'p_expression_incr_decr','calcBase.py',181),
  ('expression -> NAME DECREASE expression','expression',3,'p_expression_incr_decr','calcBase.py',182),
]
